  ...
  return (
    <>
      ...
      <section className={styles.articlesSection}>
        ...
        <article>
          <div className={styles.insuranceArticle}>
            <img
              src={insuranceLogo}
            ...
            <article>
              ...
              <p>
                ...
                Towarzystwa Ubezpieczeniowe. W ofercie mamy <br />{" "}
                przedstawicieli Polskich jak i zagranicznych a także jako <br />{" "}
                nieliczni światowego lidera ubezpieczeń na życie,
          ...
          <div className={styles.bankArticle}>
            <article>
          ...
          <div className={styles.carArticle}>
            <img
              src={carImage}
              alt="car logos"
              className={styles.sectionImages}
